...
class S3ContribCore(test_v3.RestfulTestCase):
    ...
    def test_bad_request(self):
        self.post(
            '/s3tokens', body={}, expected_status=http.client.BAD_REQUEST
        )
    ...
    def test_good_signature_v1(self):
        ...
        self.assertIsNone(
            s3tokens.S3Resource._check_signature(creds_ref, credentials)
        )
    ...
    def test_good_signature_v4(self):
        ...
        credentials = {
            ...
            'signature': '730ba8f58df6ffeadd78f402e990b2910d60'
    ...
    def test_good_iam_signature_v4(self):
        ...
        credentials = {
            ...
            'signature': 'db4e15b3040f6afaa9d9d16002de2fc3425b'
    ...
    def test_good_sts_signature_v4(self):
        ...
        credentials = {
            ...
            'MjE1NTgwZWViOWExNjczNTFiZDkzZTg2YzNiNmYwNGE5Mjhm'
            'NWM1NTIwYTM5MzVhNDUzNTQwYTA5NTY0YjU=',
            'signature': '3aa0b6f1414b92b2a32584068f83c6d09b7f'
    ...
    def test_bad_service_v4(self):
        ...
        credentials = {
            ...
            'MjE1NTgwZWViOWExNjczNTFiZDkzZTg2YzNiNmYwNGE5Mjhm'
            'NWM1NTIwYTM5MzVhNDUzNTQwYTA5NTY0YjU=',
            'signature': '1a2dec50eb1bba97887d1103c2ead6a39911'
    ...
    def test_bad_signing_key_v4(self):
        ...
        credentials = {
            ...
            'MTU1ODBlZWI5YTE2NzM1MWJkOTNlODZjM2I2ZjA0YTkyOGY1'
            'YzU1MjBhMzkzNWE0NTM1NDBhMDk1NjRiNQ==',
            'signature': '52d02211a3767d00b2104ab28c9859003b0e'
    ...
    def test_bad_short_scope_v4(self):
        ...
        credentials = {
            ...
            'MzU0MGEwOTU2NGI1',
            'signature': '28a075f1ee41e96c431153914998443ff0f5'
    ...
    def test_bad_token_v4(self):
        ...
        credentials = {
            'token': 'QVdTNC1ITUFDLVNIQTI1NgpYCi8vczMvYXdzTl9yZXF1ZXN0Clg=',
            'signature': '',
        }
        self.assertRaises(
            exception.Forbidden,
